...
@section('content')
    ...
    {{-- Override tab width so all 5 entries (including "Alliance Class") stay on one row --}}
    <style>
        /* Align 5 tabs on one row (including "Alliance Class"). Compensate existing margins (2px per side). */
                ...
                <div id="inhalt">
                    ...
                    <div id="tabs">
                        <ul class="tabsbelow" id="tab-ally">
                            @if($alliance)
                                {{-- User is in an alliance: show alliance management tabs (same structure as official OGame s274-it) --}}
                                <li class="aktiv">
