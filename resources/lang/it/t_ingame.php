...
return [
    ...
    'shipyard_page' => [
        ...
        'no_units_idle'          => 'Nessuna unità in costruzione.',
        'no_units_idle_tooltip'  => 'Nessuna unità in costruzione.',
        'to_shipyard'            => 'Vai al cantiere',
    ],
    ...
    'fleet' => [
        ...
        'tactical_retreat_full_tooltip' => 'Le flotte possono ritirarsi automaticamente quando vengono attaccate da forze molto superiori. Seleziona mai per disattivare la ritirata automatica.',
        'tactical_retreat_admiral_tooltip' => 'Usa l Ammiraglio per permettere la ritirata contro forze tre volte superiori.',
        'add_new_template'              => 'Aggiungi nuovo modello',
        'bash_warning'                  => 'Questo attacco potrebbe violare il limite bashing in questo universo.',
    ...
    'layout' => [
        ...
        'no_ships_in_wreck'          => 'Nessuna nave nel campo relitti',
        'no_wreck_available'         => 'Nessun campo relitti disponibile',
    ...
    'buildqueue' => [
        ...
        'complete_tooltip'        => 'Completa immediatamente la produzione corrente del cantiere.',
        'complete'                => 'Completa',
        'halve_cost'              => 'Costo: :amount DM',
        'halve_tooltip_building'  => 'Riduce il tempo di costruzione del 50% del tempo totale.',
        'halve_time'              => 'Dimezza tempo',
        'question_complete_unit'  => 'Vuoi completare immediatamente l ordine di costruzione per :dm_cost?',
        'question_halve_unit'     => 'Vuoi ridurre il tempo di costruzione del progetto corrente del 50% (:time_reduction) per :dm_cost?',
    ],

    'serversettings_overlay' => [
        'acs_enabled'         => 'ACS abilitato',
        'dm_bonus'            => 'Bonus Materia Oscura',
        'debris_defense'      => 'Detriti da difese',
        'debris_ships'        => 'Detriti da navi',
        'debris_deuterium'    => 'Detriti con deuterio',
        'fleet_deut_reduction'=> 'Riduzione consumo deuterio',
        ...
        'ignore_inactive'     => 'Ignora inattivi',
        'num_galaxies'        => 'Numero galassie',
        'planet_field_bonus'  => 'Bonus campi pianeta',
        'dev_speed'           => 'Velocità economia',
        'research_speed'      => 'Velocità ricerca',
        'dm_regen_enabled'    => 'Rigenerazione DM attiva',
        'dm_regen_amount'     => 'Quantità rigenerazione DM',
        'dm_regen_period'     => 'Periodo rigenerazione DM',
        'days'                => 'giorni',
    ],
    ...
    'premium' => [
        ...
        'dark_matter_description'    => 'La Materia Oscura è una sostanza rara che può essere immagazzinata solo con grande difficoltà. Ti consente di generare grandi quantità di energia. Il processo per ottenere Materia Oscura è complesso e rischioso, quindi è estremamente preziosa.<br><b>Solo la Materia Oscura acquistata e ancora disponibile può proteggere l\'account dalla cancellazione!</b>',
        'dark_matter_benefits'       => 'La Materia Oscura ti permette di assumere Ufficiali e Comandanti, pagare le offerte del mercante, spostare pianeti e acquistare oggetti.',
        'active_for_days'            => 'Attivo ancora per :days giorni',
        'not_active'                 => 'Non attivo',
        'days'                       => 'giorni',
        'advantages'                 => 'Vantaggi:',
        'buy_dark_matter'            => 'Acquista Materia Oscura',
        'insufficient_dark_matter'   => 'Non hai abbastanza Materia Oscura.',
        'purchase_success'           => 'Ufficiale acquistato con successo.',
        'commanding_staff_redundant' => 'Lo Stato Maggiore non puo essere acquistato quando tutti e cinque gli ufficiali sono gia attivi singolarmente.',
        'officer_commander_title'       => 'Comandante',
        'officer_commander_description' => 'Il Comandante gestisce e ottimizza le code di costruzione di tutti i tuoi pianeti. Inoltre organizza meglio i tuoi messaggi e rende il tuo impero privo di pubblicità.',
        'officer_commander_tooltip'     => '<b>+40 preferiti</b><p>Con più preferiti puoi salvare più messaggi, che potranno poi essere condivisi.</p><br/><b>Coda di costruzione</b><p>Inserisci fino a 4 contratti di costruzione aggiuntivi contemporaneamente nella coda di costruzione.</p><br/><b>Scanner trasporti</b><p>Verrà mostrata la quantità di risorse che il trasporto sta portando al tuo pianeta.</p><br/><b>Senza pubblicità</b><p>Non vedrai più pubblicità per altri giochi, ma solo annunci relativi a eventi e offerte specifici di OGame.</p>',
        'officer_admiral_title'         => 'Ammiraglio',
        'officer_admiral_description'   => 'L\'Ammiraglio guida le tue flotte in battaglia. Sotto il suo comando, le tue flotte sono meglio organizzate e più efficaci.',
        'officer_admiral_tooltip'       => '<b>Slot flotta max +2</b><p>Puoi inviare più flotte contemporaneamente.</p><br/><b>Spedizioni max +1</b><p>Puoi inviare una spedizione aggiuntiva contemporaneamente.</p><br/><b>Tasso di fuga migliorato</b><p>Finché non raggiungi 500.000 punti, la tua flotta può ritirarsi quando le forze nemiche sono tre volte più grandi delle tue.</p><br/><b>Slot salvataggio simulazione +20</b><p>Puoi salvare più simulazioni di combattimento contemporaneamente.</p>',
        'officer_engineer_title'        => 'Ingegnere',
        'officer_engineer_description'  => 'L\'Ingegnere supervisiona i sistemi di difesa dei tuoi pianeti e garantisce che funzionino nel modo più efficiente possibile.',
        'officer_engineer_tooltip'      => '<b>Dimezza le perdite delle difese</b><p>Dopo una battaglia, metà di tutti i sistemi di difesa persi verrà ricostruita.</p><br/><b>+10% produzione energia</b><p>Le tue centrali elettriche e i satelliti solari producono il 10% di energia in più.</p>',
        'officer_geologist_title'       => 'Geologo',
        'officer_geologist_description' => 'Il Geologo analizza il suolo dei tuoi pianeti e trova modi per estrarre più risorse.',
        'officer_geologist_tooltip'     => '<b>+10% produzione miniere</b><p>Le tue miniere producono il 10% in più.</p>',
        'officer_technocrat_title'       => 'Tecnocrate',
        'officer_technocrat_description' => 'Il Tecnocrate ricerca nuove tecnologie e garantisce che i progetti di ricerca vengano completati più velocemente.',
        'officer_technocrat_tooltip'     => '<b>+2 livelli spionaggio</b><p>Verranno aggiunti 2 livelli alla tua ricerca di spionaggio.</p><br/><b>25% di tempo ricerca in meno</b><p>La tua ricerca richiede il 25% di tempo in meno per completarsi.</p>',
        'officer_all_officers_title'       => 'Stato Maggiore',
        'officer_all_officers_description' => 'Se assumi tutti e cinque gli ufficiali, riceverai bonus aggiuntivi per l\'intero impero.',
        'officer_all_officers_tooltip'     => '<b>Slot flotta max +1</b><p>Puoi inviare più flotte contemporaneamente.</p><br/><b>+2% produzione energia</b><p>Le tue centrali elettriche e i satelliti solari producono il 2% di energia in più.</p><br/><b>+2% produzione miniere</b><p>Le tue miniere producono il 2% in più.</p><br/><b>+1 livelli spionaggio</b><p>Verrà aggiunto 1 livello alla tua ricerca di spionaggio.</p>',
        'officer_commander_benefit_favourites' => '+40 preferiti',
        'officer_commander_benefit_queue'      => 'Coda di costruzione',
        'officer_commander_benefit_scanner'    => 'Scanner trasporti',
        'officer_commander_benefit_ads'        => 'Senza pubblicità',
        'officer_admiral_benefit_fleet_slots'  => 'Slot flotta max +2',
        'officer_admiral_benefit_expeditions'  => 'Spedizioni max +1',
        'officer_admiral_benefit_escape'       => 'Tasso di fuga migliorato',
        'officer_admiral_benefit_save_slots'   => 'Slot salvataggio simulazione +20',
        'officer_engineer_benefit_defence'     => 'Dimezza le perdite delle difese',
        'officer_engineer_benefit_energy'      => '+10% produzione energia',
        'officer_geologist_benefit_mines'      => '+10% produzione miniere',
        'officer_technocrat_benefit_espionage' => '+2 livelli spionaggio',
        'officer_technocrat_benefit_research'  => '25% di tempo ricerca in meno',
        'officer_all_officers_benefit_fleet_slots' => 'Slot flotta max +1',
        'officer_all_officers_benefit_energy'      => '+2% produzione energia',
        'officer_all_officers_benefit_mines'       => '+2% produzione miniere',
        'officer_all_officers_benefit_espionage'   => '+1 livelli spionaggio',
    ],
