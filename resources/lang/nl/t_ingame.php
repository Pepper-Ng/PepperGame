...
return [
    ...
    'shipyard_page' => [
        ...
        'no_units_idle'          => 'Geen eenheden in aanbouw.',
        'no_units_idle_tooltip'  => 'Geen eenheden in aanbouw.',
    ...
    'fleet' => [
        ...
        'tactical_retreat_full_tooltip' => 'Vloten kunnen automatisch terugtrekken wanneer ze door veel sterkere strijdkrachten worden aangevallen. Kies nooit om automatisch terugtrekken uit te schakelen.',
        'tactical_retreat_admiral_tooltip' => 'Gebruik de Admiraal om terugtrekken tegen 3:1 mogelijk te maken.',
        'add_new_template'              => 'Nieuwe template toevoegen',
        'bash_warning'                  => 'Deze aanval kan de bash-limiet in dit universum overschrijden.',
        'admiral_slot_bonus'            => '+ 2 vlootslots door Admiraal',
        'general_slot_bonus'            => '+ 2 vlootslots door Generaal',
        'continue'                      => 'Doorgaan',
        'back'                     => 'Terug',
    ...
    'layout' => [
        ...
        'no_ships_in_wreck'          => 'Geen schepen in wrakveld',
    ...
    'buildqueue' => [
        ...
        'complete_tooltip'        => 'Voltooit direct de huidige scheepswerfbouw.',
        'complete'                => 'Voltooien',
        ...
        'question_complete_unit'  => 'Wil je de bouwopdracht direct voltooien voor :dm_cost?',
        'question_halve_unit'     => 'Wil je de bouwtijd van het huidige project met 50% verminderen (:time_reduction) voor :dm_cost?',
    ],

    'serversettings_overlay' => [
        'acs_enabled'         => 'ACS ingeschakeld',
        'dm_bonus'            => 'Donkere Materie bonus',
        'debris_defense'      => 'Puin van defensie',
        'debris_ships'        => 'Puin van schepen',
        'debris_deuterium'    => 'Puin bevat deuterium',
        'fleet_deut_reduction'=> 'Deuteriumverbruik reductie',
        'fleet_speed_war'     => 'Vlootsnelheid (oorlog)',
        'fleet_speed_holding' => 'Vlootsnelheid (stationeren)',
        'fleet_speed_peace'   => 'Vlootsnelheid (vrede)',
        'ignore_empty'        => 'Lege systemen negeren',
        'ignore_inactive'     => 'Inactieve spelers negeren',
        'num_galaxies'        => 'Aantal sterrenstelsels',
        'planet_field_bonus'  => 'Planeet veldbonus',
        'dev_speed'           => 'Economie snelheid',
        'research_speed'      => 'Onderzoeksnelheid',
        'dm_regen_enabled'    => 'DM regeneratie actief',
    ...
    'premium' => [
        ...
        'dark_matter_description'    => 'Donkere Materie is een zeldzame substantie die alleen met grote moeite kan worden opgeslagen. Hiermee kun je grote hoeveelheden energie genereren. Het proces om Donkere Materie te verkrijgen is complex en riskant, waardoor het extreem waardevol is.<br><b>Alleen gekochte Donkere Materie die nog beschikbaar is, kan beschermen tegen accountverwijdering!</b>',
        'dark_matter_benefits'       => 'Met Donkere Materie kun je Officieren en Commandanten inhuren, koopman-aanbiedingen betalen, planeten verplaatsen en items kopen.',
        'active_for_days'            => 'Nog :days dagen actief',
        ...
        'purchase_success'           => 'Officier succesvol gekocht.',
        'commanding_staff_redundant' => 'Commandostaf kan niet worden gekocht wanneer alle vijf officieren al individueel actief zijn.',
        'officer_commander_title'       => 'Commandant',
        'officer_commander_description' => 'De Commandant beheert en optimaliseert de bouwrijen van al jouw planeten. Hij zorgt er ook voor dat je berichten beter georganiseerd zijn en dat jouw imperium reclamevrij is.',
        'officer_commander_tooltip'     => '<b>+40 favorieten</b><p>Met meer favorieten kun je meer berichten opslaan, die daarna ook gedeeld kunnen worden.</p><br/><b>Bouwrij</b><p>Plaats tot 4 extra bouwopdrachten tegelijk in de bouwrij.</p><br/><b>Transportscanner</b><p>Het aantal grondstoffen dat een transporteur naar jouw planeet brengt wordt weergegeven.</p><br/><b>Reclamevrij</b><p>Je ziet geen reclame meer voor andere games, alleen nog meldingen over OGame-specifieke evenementen en aanbiedingen.</p>',
        'officer_admiral_title'         => 'Admiraal',
        'officer_admiral_description'   => 'De Admiraal leidt jouw vloten in de strijd. Onder zijn bevel zijn jouw vloten beter georganiseerd en effectiever.',
        'officer_admiral_tooltip'       => '<b>Max. vlootslots +2</b><p>Je kunt meer vloten tegelijkertijd sturen.</p><br/><b>Max. expedities +1</b><p>Je kunt gelijktijdig een extra expeditie uitsturen.</p><br/><b>Verbeterde ontsnappingskans vloot</b><p>Tot je 500.000 punten bereikt, kan jouw vloot zich terugtrekken wanneer de tegenstander drie keer sterker is dan jij.</p><br/><b>Opslagslots gevechtssimulatie +20</b><p>Je kunt meer gevechtssimulaties tegelijk opslaan.</p>',
        'officer_engineer_title'        => 'Ingenieur',
        'officer_engineer_description'  => 'De Ingenieur houdt toezicht op de verdedigingssystemen van jouw planeten en zorgt ervoor dat ze zo efficient mogelijk werken.',
        'officer_engineer_tooltip'      => '<b>Halveert verliezen van verdedigingssystemen</b><p>Na een gevecht wordt de helft van alle verloren verdedigingssystemen herbouwd.</p><br/><b>+10% energieproductie</b><p>Jouw energiecentrales en zonnesatellieten produceren 10% meer energie.</p>',
        'officer_geologist_title'       => 'Geoloog',
        'officer_geologist_description' => 'De Geoloog analyseert de bodem van jouw planeten en vindt manieren om meer grondstoffen te winnen.',
        'officer_geologist_tooltip'     => '<b>+10% mijnproductie</b><p>Jouw mijnen produceren 10% meer.</p>',
        'officer_technocrat_title'       => 'Technocraat',
        'officer_technocrat_description' => 'De Technocraat onderzoekt nieuwe technologieen en zorgt ervoor dat onderzoeksprojecten sneller worden voltooid.',
        'officer_technocrat_tooltip'     => '<b>+2 spionageniveaus</b><p>Er worden 2 niveaus toegevoegd aan jouw spionageonderzoek.</p><br/><b>25% minder onderzoekstijd</b><p>Jouw onderzoek heeft 25% minder tijd nodig om te voltooien.</p>',
        'officer_all_officers_title'       => 'Commandostaf',
        'officer_all_officers_description' => 'Als je alle vijf officieren inhuurt, krijg je extra bonussen voor jouw hele imperium.',
        'officer_all_officers_tooltip'     => '<b>Max. vlootslots +1</b><p>Je kunt meer vloten tegelijkertijd sturen.</p><br/><b>+2% energieproductie</b><p>Jouw energiecentrales en zonnesatellieten produceren 2% meer energie.</p><br/><b>+2% mijnproductie</b><p>Jouw mijnen produceren 2% meer.</p><br/><b>+1 spionageniveaus</b><p>Er wordt 1 niveau toegevoegd aan jouw spionageonderzoek.</p>',
        'officer_commander_benefit_favourites' => '+40 favorieten',
        'officer_commander_benefit_queue'      => 'Bouwrij',
        'officer_commander_benefit_scanner'    => 'Transportscanner',
        'officer_commander_benefit_ads'        => 'Reclamevrij',
        'officer_admiral_benefit_fleet_slots'  => 'Max. vlootslots +2',
        'officer_admiral_benefit_expeditions'  => 'Max. expedities +1',
        'officer_admiral_benefit_escape'       => 'Verbeterde ontsnappingskans vloot',
        'officer_admiral_benefit_save_slots'   => 'Opslagslots gevechtssimulatie +20',
        'officer_engineer_benefit_defence'     => 'Halveert verliezen van verdedigingssystemen',
        'officer_engineer_benefit_energy'      => '+10% energieproductie',
        'officer_geologist_benefit_mines'      => '+10% mijnproductie',
        'officer_technocrat_benefit_espionage' => '+2 spionageniveaus',
        'officer_technocrat_benefit_research'  => '25% minder onderzoekstijd',
        'officer_all_officers_benefit_fleet_slots' => 'Max. vlootslots +1',
        'officer_all_officers_benefit_energy'      => '+2% energieproductie',
        'officer_all_officers_benefit_mines'       => '+2% mijnproductie',
        'officer_all_officers_benefit_espionage'   => '+1 spionageniveaus',
    ],
