...
class SpeedPropertyService extends ObjectPropertyService
{
    ...
    public function calculateProperty(PlayerService $player): GameObjectPropertyDetails
    {
        ...
        // Apply alliance class speed bonuses (Trader: +10% cargo speed).
     ...
     *
    * Trader (Alliance): +10% cargo speed for Small Cargo (id 202) and Large Cargo (id 203).
    * Verified on official OGame UI s274-it: "Cargo speed: +10%".
     *
     * @return int Percentage bonus (0-100)
     */
